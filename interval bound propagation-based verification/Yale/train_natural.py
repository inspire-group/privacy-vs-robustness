...
flags.DEFINE_integer('width_num', 2, 'Width Number for CNN')
# Options.
flags.DEFINE_integer('steps', 20001, 'Number of steps in total.')
flags.DEFINE_integer('test_every_n', 1000,
...
flags.DEFINE_float('epsilon', 0.02, 'Target epsilon.')
...
def layers(model_size, width_num=1):
