...
if __name__ == "__main__": 
    ...
    train_loader, test_loader = pblm.fmnist_loaders(args.batch_size, args.test_batch_size)
    ...
    sampler_indices = []
    model = [fmnist_model(args.width_num).cuda()]
    ...
    for _ in range(0,args.cascade): 
        ...
        lr_scheduler = optim.lr_scheduler.StepLR(opt, step_size=15, gamma=0.1)
        ...
        for t in range(args.epochs):
            ...
            # robust training
                ...
                for param_group in opt.param_groups:
                    print( param_group['lr'], epsilon)
                train_robust(train_loader, model[0], opt, epsilon, t,
                   train_log, args.verbose, args.real_time,
                   norm_type=args.norm_train, bounded_input=True, clip_grad=1, **kwargs)
                ##############################################################################
